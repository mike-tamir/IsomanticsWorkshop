...
def plot_heatmaps(T_matrix_dict,
    ...
    write_heatmaps  str specifying the path to write the heatmaps to.
                    If False Default nothing is written.
    """
    ...
    for matrix_type in matrix_types:
        ...
        for stat in plotted_stats:
            ...
            if display_opt=="cols":
                ...
                if write_heatmaps!=False:
                    # Construct new dir to heatmaps sub dir to write to
                    heatmap_dir = write_heatmaps.rstrip("/")+"/heatmaps/"
                    # Check if dir exists and make dir if not
                    if not os.path.exists(heatmap_dir):
                        os.makedirs(heatmap_dir)
                    # make heatmap path
                    heatmap_full_path = heatmap_dir+matrix_type+"_"+stat+".png"

                    # write the plot
                    plt.savefig(heatmap_full_path, bbox_inches="tight")
